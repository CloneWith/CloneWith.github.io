...
![两条 Flag 字符串？](img/11/two-flag-strings.png)
...
![SHA3 爆破结果](img/11/sha3-bruteforce-result.png)
...
![HTA 文件中显示的 ID](img/11/id-in-hta.png)

#### 恢复与分析溯源 (4~8)

一般来说，病毒加密文件的修改时间会非常接近，因此从感染文件的修改时间不难得出加密时间为 `2025/11/19 14:31`。

![相近的修改时间](img/11/close-change-time.png)
...
![镜像中的 flag.bak](img/11/flag-bak-fs.png)
...
![.config.php WebShell](img/11/config-php-shell.png)
