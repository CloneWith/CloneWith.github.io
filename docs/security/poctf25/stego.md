...
![对着图片手做二维码](image/stego/handmade-qr.png)
...
![波形图中的 Flag](image/stego/flag-in-waves.png)
...
![组合 Flag](image/stego/composed-flag.png)
...
| Part2 | Part3 |
| :-: | :-: |
| ![Part 2](image/stego/merged-part2.png) | ![Part 3](image/stego/merged-part3.png) |
...
![PDF 中的编码信息](image/stego/chars-in-pdf.png)
...
![帧与帧之间的差异组合](image/stego/diff-between-frames.png)
