...
![浏览器数据库内的历史记录](image/forensics/entry-in-db.png)

![网站上的 Flag](image/forensics/web-flag.png)
...
![缩略图中的 Flag](image/forensics/thumbnail-flag.png)
...
![`secret.db` 中的 Flag](image/forensics/secret-db-flag.png)
...
![设置内存扫描模式](image/forensics/mem-search-mode.png)

![内存中搜索到的 Flag 字符串](image/forensics/flag-in-mem.png)
