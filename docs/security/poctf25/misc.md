...
| Cipher | Puzzle |
| :-: | :-: |
| ![Cipher](image/misc/fri-cipher.png) | ![Puzzle](image/misc/fri-puzzle.png) |

密码使用的是 Magicode

![Magicode Reference](image/misc/fri-magi.png)
...
![Puzzle solved in PPT](image/misc/incognita-puzzle.png)
